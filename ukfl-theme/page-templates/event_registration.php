...
$admin_msg = 'New event registration on '.get_bloginfo('name').':<br /><br />
	...
	Venue: <strong>'.get_post_meta($event->ID, 'ukfl_event_venue', 1).', '.get_post_meta($event->ID, 'ukfl_event_postcode', 1).'</strong><br />
	Comments: '.get_post_meta($event->ID, 'ukfl_event_notes', 1).'<br /><br />';
