...
<div id="page" class="hfeed site">
	...
	<?php 
		...
		if( ( (is_page() && !is_front_page() ) || is_404() ) && ( of_get_option('show_alexandria_slider_page') == 'true' ) ) {
			get_template_part( 'slider' );
		}
		
		if( ( is_single() ) && ( of_get_option('show_alexandria_slider_single') == 'true' ) ) {
			get_template_part( 'slider' );
		}
		
		if( ( is_archive() || (is_home() && !is_front_page()) ) && ( of_get_option('show_alexandria_slider_archive') == 'true' ) ) {
			get_template_part( 'slider' );
		}
