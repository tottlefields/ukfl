...
<div class="tml tml-profile" id="theme-my-login<?php $template->the_instance(); ?>">
	...
	<form class="form form-horizontal" id="your-profile" action="<?php $template->the_action_url( 'profile', 'login_post' ); ?>" method="post">
		...
		<div class="form-group">
			<label for="first_name" class="col-sm-2 control-label"><?php _e( 'First Name', 'theme-my-login' ); ?></label>
			<div class="col-sm-10"><input type="text" class="form-control" name="first_name" id="first_name" value="<?php echo esc_attr( $profileuser->first_name ); ?>" placeholder="<?php _e( 'First Name', 'theme-my-login' ); ?>"></div>
		</div>
